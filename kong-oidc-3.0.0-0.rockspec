...
version = "3.0.0-0"
source = {
    url = "git://github.com/lendtech/kong-oidc",
    tag = "3.0.0-0",
    dir = "kong-oidc"
}
description = {
    summary = "A Kong 3.x+ plugin for implementing the OpenID Connect Relying Party (RP) functionality",
    detailed = [[
    ...
    homepage = "https://github.com/lendtech/kong-oidc",
    license = "Apache 2.0"
}
dependencies = {
